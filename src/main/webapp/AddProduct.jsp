    ...
    <div class="col-md-6">
        <div class="card">
            ...
            <article class="card-body">
                ...
                <form class ="form-addProduct" id="addProduct-form" action = "/products/add/<%=id%>" method="post" enctype="multipart/form-data">
                    <form :hidden path="id"/>
                    <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="p_quantity" name="p_quantity" class="form-control" placeholder="">

                    </div>

                    <div class="form-group">
                        <label>Production Time</label>
                        <input type="text" id="p_productiontime" name="p_productiontime" class="form-control" placeholder="">
                    </div>
                    ...
                    <div class="form-label-group">
						...
						<select id="category" name="category" class="form-control">
						  ...
						  <option value="grooming">Grooming,beauty,health</option>
