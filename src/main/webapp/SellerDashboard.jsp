...
<div class="jumbotron">
    <div class="container" style="font-family: Ubuntu; font-size: large">
        ...
        <h1> Welcome to Central seller Platform!</h1>
        <p>We provide platform to add product with every possible feature and pull it on any seller account of ECommerce website</p>
        <p >Start Selling...</p>
    </div>
</div>
